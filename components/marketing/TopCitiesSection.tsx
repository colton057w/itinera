      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {cities.map((city, i) => (
          <Link
            ...
            scroll={false}
            className="group relative overflow-hidden rounded-[1.75rem] border border-neutral-200/80 bg-neutral-100 shadow-md transition duration-300 hover:-translate-y-1 hover:border-emerald-300/60 hover:shadow-2xl dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-emerald-700/50"
          >
            <div className="relative aspect-[4/3] w-full overflow-hidden">
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 text-white">
                ...
                <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-emerald-200 transition group-hover:text-white">
                  Explore experiences
