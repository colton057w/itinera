...
| `NEXT_PUBLIC_TRAVELPAYOUTS_MARKER` | Optional; Travelpayouts affiliate marker for one-click booking links (flights via Aviasales, hotels via Hotellook). Without it, booking links still work but are not tracked. |
